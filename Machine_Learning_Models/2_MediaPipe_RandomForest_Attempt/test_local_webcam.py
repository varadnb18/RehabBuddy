...
# python test_local_webcam.py --model RandomForest_Classifier.joblib --camera 0
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default='RandomForest_Classifier.joblib', help='Path to trained model file')
